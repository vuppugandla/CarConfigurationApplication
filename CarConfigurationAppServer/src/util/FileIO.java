...
public class FileIO {
	...
	/*Used if properties file is read as text file*/
	public Automobile parsePropertiesTxt(String fileName) throws AutoException {
		FileInputStream in;
	...
	/*Method to parse properties object received from client and then load the automobile object*/
	public Automobile parseProperties(Properties props){
